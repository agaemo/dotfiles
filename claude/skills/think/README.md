...
| 収束 | [wardley](wardley/) | 事業・製品・システムをバリューチェーン×進化軸で可視化し戦略判断を導きたい | Wardley (2005) |
| 対話 | [dialogue](dialogue/) | 答え・方向性がまだ定まっていない曖昧な相談に、問いを重ねて壁打ちしたい | Paul & Elder (1990s) / Whitmore (1992) |
...
**対話**とは、発散（アイデアが欲しい）でも収束（案を検証したい）でもなく、本人の中で答え・方向性そのものがまだ定まっていない曖昧な相談を指す。「なんとなくモヤモヤする」を、問いを重ねながら本人の言葉で整理するフェーズ。
...
| 収束 | 「内製すべきか外注すべきか」「どこに投資するか」という戦略的構造整理が目的 | wardley |
