...
以下の形式で Mermaid の quadrantChart として出力する。x軸は進化段階（Genesis:0.1 / Custom:0.35 / Product:0.6 / Commodity:0.85 を目安に配置）、y軸は可視性（高:0.8 / 中:0.5 / 低:0.2 を目安に配置）とし、[...] の部分に実際のコンポーネント名と座標を埋めて出力すること。
