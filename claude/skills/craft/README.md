...
flowchart TD
    ...
    ROUTE -->|2. Webアプリ\nNode.js系・API・DB・認証あり| DYNAMIC[new-project フロー]
    ROUTE -->|3. クロスプラットフォームアプリ\nFlutter・React Native・Expo等| APP[new-app フロー]
...
| `new-app` | クロスプラットフォームアプリ（Flutter・React Native・Expo等）のセットアップ手順。 |
