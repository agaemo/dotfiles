...
Bun / Python の場合: `READ {SKILL_DIR}/flows/new-project/recipes/runtime-bun-python.md`
...
READ {SKILL_DIR}/flows/new-project/recipes/planner-checklist.md（STEP 4: planner の直前に参照）
