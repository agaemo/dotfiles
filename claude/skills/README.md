...
| [`/think`](think/) | 相談内容に応じて dialogue / structure / root-cause / decide / six-hats / idea / reflect / triz へ委譲する思考・分析オーケストレーター |
...
| [`/output-brief`](output-brief/) | アウトプットを伴うタスクでスコープ・形式・スタイルを確認してから出力まで担当する。HTML はレイアウト×カラーテーマの組み合わせをユーザーに選ばせる |
